# llama3-70b # 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
# llama3-8b # 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
...
# 设置 OpenAI API 密钥
openai.api_key = "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"
openai.api_base = "https://integrate.api.nvidia.com/v1"
class Agent:
    def __init__(self, Conversation_History: List[Dict] = None, model="meta/llama3-70b-instruct"):
...
if __name__ == "__main__":
    ...
    '''
    handler = Agent(model="meta/llama3-70b-instruct")
